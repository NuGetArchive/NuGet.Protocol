...
namespace NuGet.Client
{
    ...
    public sealed class V3DependencyInfoResource : DepedencyInfoResource
    {
        ...
        public override async Task<IEnumerable<PackageDependencyInfo>> ResolvePackages(IEnumerable<PackageIdentity> packages, NuGetFramework projectFramework, bool includePrerelease = false)
        {
